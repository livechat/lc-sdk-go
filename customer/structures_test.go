...
func FilledFormFromJSON(t *testing.T, rawEvent json.RawMessage) *customer.FilledForm {
	t.Helper()
...
func FilledFormFieldFromJSON(t *testing.T, rawFields json.RawMessage) *customer.FilledFormField {
	t.Helper()
