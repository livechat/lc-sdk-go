...
// ListChats returns chat info for the chats a Customer participated in.
...
func (a *API) UpdateCustomer(name, email, avatarURL, phoneNumber, suggestedEmail string, sessionFields []map[string]string, nameIsDefault *bool, address *Address) error {
...
func (a *API) RequestWelcomeMessage(welcomeMessageID string, groupID *int, aiAgentResponseScope string) (string, *PredictedAgentV2, bool, error) {
