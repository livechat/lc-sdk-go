...
import (
	...
	i "github.com/livechat/lc-sdk-go/v7/internal"
)
...
// ListChats returns chat info for the chats an Agent has access to.
...
func (a *API) UpdateCustomer(customerID string, name, email, avatar, phoneNumber, suggestedEmail *string, sessionFields []map[string]string, address *AddressUpdate) error {
