...
func TestUpdateCustomerSendsSuggestedEmail(t *testing.T) {
	...
	body := captureUpdateCustomerBody(t, func(api *agent.API) error {
		return api.UpdateCustomer("customer_id", nil, nil, nil, nil, &suggestion, nil, nil)
	})
...
func TestUpdateCustomerSendsDismissalAsEmptyValue(t *testing.T) {
	dismissal := ""
	body := captureUpdateCustomerBody(t, func(api *agent.API) error {
		return api.UpdateCustomer("customer_id", nil, nil, nil, nil, &dismissal, nil, nil)
	})
...
func TestUpdateCustomerOmitsUntouchedSuggestedEmail(t *testing.T) {
	body := captureUpdateCustomerBody(t, func(api *agent.API) error {
		return api.UpdateCustomer("customer_id", nil, nil, nil, nil, nil, nil, nil)
	})
