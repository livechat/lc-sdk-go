...
func incomingChat(wh *webhooks.Webhook) error {
	...
	propEq("Customer.LastSeen", customer.EventsSeenUpTo.String(), "2019-10-08 13:56:53 +0200 CEST", &errors)
	...
	propEq("Agent.LastSeen", agent.EventsSeenUpTo.String(), "1970-01-01 01:00:00 +0100 CET", &errors)
